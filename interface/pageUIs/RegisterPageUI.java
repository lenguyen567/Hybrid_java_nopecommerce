...
public class RegisterPageUI {
	...
	public static final String WRONG_EMAIL_ERROR = "//div[contains(@class,'message-error')]//li";
	...
	public static final String FIRSTNAME_TETXBOX = "//input[@id='FirstName']";
	...
	public static final String EMAIL_EXIST_ERROR_MESSAGE = "//div[contains(@class,'message-error')]//li";
